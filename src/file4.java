...
public class file4 extends JFrame
{
	...
	private void initializeComponent()
	{
		...
		this.setTitle("Volunteer Storage 4 ");
			...
			if(req.equalsIgnoreCase("send"))
				{
					...
					FileOutputStream fout=new FileOutputStream("vss4\\"+fra_name);
				...
				fra_name=dis.readUTF();
				data="";
				data=v4obj.fileToString(fra_name);
	...
	{
	FileInputStream fis=new FileInputStream("vss4\\"+filename);
