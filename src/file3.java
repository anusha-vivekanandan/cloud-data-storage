...
public class file3 extends JFrame
{
	...
	private void initializeComponent()
	{
		...
		this.setTitle("Volunteer Storage 3");
			...
			if(req.equalsIgnoreCase("send"))
				{
					...
					FileOutputStream fout=new FileOutputStream("vss3\\"+fra_name);
				...
				fra_name=dis.readUTF();
				data="";
				data=v3obj.fileToString(fra_name);
	...
	{
	FileInputStream fis=new FileInputStream("vss3\\"+filename);
